# 👾🛍️ CheckShop — English E-Commerce Sentiment Analyzer

Aplikasi analisis sentimen ulasan e-commerce inggris menggunakan 4 model : **Logistic Regression**, **Naive Bayes**, **XGBoost**, dan **BERT**.
...
- Teks ulasan dalam aksara Bangla dihapus
